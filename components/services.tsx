...
const services = [
  ...
  {
    title: 'Aparatología',
    description: 'Tecnología de vanguardia para resultados excepcionales en tratamientos faciales y corporales.',
    icon: Zap,
  ...
  {
    title: 'Facial Aparatología',
    description: 'Rejuvenecimiento facial avanzado con la última tecnología en cuidado de la piel.',
    icon: Fingerprint,
    image: 'https://images.unsplash.com/photo-1570174006382-d8d28f2a5b82?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80'
  },
  {
    title: 'Cama Solar',
    description: 'Bronceado seguro y controlado para un resplandor saludable todo el año.',
    icon: Sun,
    image: 'https://images.unsplash.com/photo-1532926381893-7542290edf1d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80'
  },
  {
  ...
  {
    title: 'Ozonoterapia',
    description: 'Tratamientos innovadores con ozono medicinal para mejorar tu salud y belleza.',
    icon: Droplet,
  ...
  },
  {
    ...
    description: 'Depilación higiénica y segura para una piel suave y libre de vello.',
    icon: Scissors,
    image: 'https://images.unsplash.com/photo-1609357605129-26f69add5d6e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80'
  },
  {
    title: 'Depilación Definitiva',
    description: 'Di adiós al vello no deseado con nuestros tratamientos de depilación permanente.',
    icon: Infinity,
    image: 'https://images.unsplash.com/photo-1598524374912-6b0b0bab49d9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80'
  },
  {
    title: 'Masajes',
    description: 'Relájate y rejuvenece con nuestras técnicas especializadas de masaje.',
    icon: Massage,
    image: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80'
  },
  {
    title: 'Pestañas y Cejas',
    description: 'Realza tu mirada con nuestros servicios profesionales de diseño y tratamiento.',
    icon: Eye,
    image: 'https://images.unsplash.com/photo-1588511405746-e84feab4a05e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80'
  },
  {
    title: 'Uñas',
    description: 'Luce unas manos y pies impecables con nuestros servicios de manicura y pedicura.',
    icon: Paintbrush,
    ...
    <section id="servicios" className="py-24 bg-gradient-to-b from-accent to-background">
      ...
      <Dialog open={!!selectedService} onOpenChange={() => setSelectedService(null)}>
        <DialogContent className="sm:max-w-[625px]" aria-describedby={descriptionId}>
          <DialogHeader>
            <DialogTitle className="text-2xl font-serif text-secondary">
